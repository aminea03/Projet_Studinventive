...
<body>
    <div class="top_menu_bar">
        ...
        <ul class="top_menu_bar_links">
            ...
            <li><a href=""><img src="images/connection_icon.svg" alt="Icone connexion">Connexion</a></li>
        </ul>
    </div>
    <header>
        <div class="nav_container">
            ...
            <ul id="dropdown1" class="dropdown-content">
                ...
                <li><a href="#!">Offres entreprises</a></li>
            </ul>
            <nav>
                <ul>
                    <li><a href="" class="current_page">Accueil</a></li>
                    ...
                    <li class="nav_li_campus"><a>Accès campus</a></li>
                </ul>
            </nav>
        </div>
    </header>
    <main>
        <section class="landing_section">
            ...
            <div class="landing_section_right">
                ...
                <div class="landing_section_buttons">
                    <a href="" class="waves-effect waves-light btn">Accès campus</a>
                    <a href="" class="waves-effect waves-light btn">Inscription gratuite</a>
                </div>
            </div>
        </section>
        <section class="method_section">
            ...
            <div class="method_section_content">
                ...
                <ul>
                    <li>
                        <p>Nos formations sont conçues sous forme de challenges (projets) en partenariat avec des
                            professionnels. L'objectif est de rendre nos apprenants opérationnels le plus rapidement
                            possible.</p>
                    </li>
                    <li>
                        <p>Nous proposons un algorithme capable de conseiller les apprenants sur leur style
                            d'apprentissage, leur potentiel et leurs capacités.</p>
                    </li>
                    <li>
                        <p>Des mentors et des coachs certifiés sont à votre disposition pour vous accompagner tout
                            au
                            long de votre parcours.</p>
                    </li>
                </ul>
            </div>
        ...
        <section class="model_section">
            ...
            <div class="model_section_card_container">
                <div class="pedagogy_card model_section_card">
                    <h3>Pédagogie par projet</h3>
                    <div class="card_circle1"></div>
                    <img src="images/method1.png" class="model_section_img" alt="Illustration d'une fusée">
                    <p>Développez des compétences en relevant des challenges sous forme de projets conçus à partir
                        d'un
                        contexte professionnel.</p>
                </div>
                <div class="approach_card model_section_card">
                    <h3>Approche personnalisée</h3>
                    <div class="card_circle2"></div>
                    <img src="images/method2.png" class="model_section_img" alt="Illustration d'engrenage">
                ...
                <div class="community_card model_section_card">
                    <h3>Communauté d'apprentissage</h3>
                    <div class="card_circle3"></div>
                    <img src="images/method3.webp" class="model_section_img" alt="Illustration d'élèves">
        ...
        <section class="training_section">
            ...
            <a href="" class="waves-effect waves-light btn">Toutes les formations</a>
        </section>
        <section class="challenge_section">
            ...
            <div class="challenges_container">
                <div class="challenge">
                    <p class="challenge_header">Gratuit</p>
                    <div class="challenge_content">
                        ...
                        <p class="challenge_provider">Proposé par CoFormA</p>
                        <div class="challenge_time">
                            <p>30</p>
                            <p>h</p>
                        </div>
                    </div>
                    <div class="challenge_level">
                        <!-- appliquer la classe "level_on" sur le niveau approprié -->
                        <p class="challenge_level_1">Débutant</p>
                        <p class="challenge_level_2 level_on">Intermédiaire</p>
                        <p class="challenge_level_3">Expert</p>
                    </div>
                </div>
            ...
            <a href="" class="waves-effect waves-light btn">Tous les challenges</a>
        </section>
        <section class="reviews_section">
            ...
            <div class="reviews_container">
                <div class="review">
                    <p class="review_name">Hector</p>
                    <div class="review_content">
                        <!-- le ratio de l'image doit être de 21/24  -->
                        <img src="images/review_1.jpg" alt="Personne">
                        <div class="review_content_right">
                            <p class="review_title">Créateur de mode</p>
                            <p class="review_text"><span>" </span>Suite à ma formation et grâce à mon sens inné de
                                l'esthétique, j'ai ouvert mon atelier de modiste et embauché une couturière.<span>
                                    "</span>
                            </p>
                        </div>
                    </div>
                ...
                <div class="review">
                    <p class="review_name">Victoria</p>
                    <div class="review_content">
                        <img src="images/review_2.jpg" alt="Personne">
                        <div class="review_content_right">
                            <p class="review_title">Mécanicienne</p>
                            <p class="review_text"><span>" </span>J'ai décidé de faire appel à Studinventive pour
                                mettre
                                à niveau mes connaissances en mécaniques, grâce à mon CPF.<span>
                                    "</span>
                            </p>
                        </div>
                    </div>
        ...
        <section class="more_section">
            ...
            <div class="carousel">
                ...
                <div class="carousel-item">
                    <a href="">
                        <img src="images/label5.png" alt="">
                    </a>
                </div>
                <div class="carousel-item">
                    <a href="">
                        <img src="images/label6.png" alt="">
                    </a>
                </div>
            </div>
        </section>
